...
- (2025年12月) 第4部「[細かすぎて伝わらない編（仮）](#41c))」を試験的に公開。現在 GitHub スポンサーの仕組みを利用したサポーター限定公開です。
...
あくまでおまけとしてですが、サポーターの皆様には、「第4部」の内容を含む開発中の [プライベートリポジトリ](https://github.com/99-investing/99-investing)へのアクセス権限が自動的に付与されます。ぜひ皆様からのフィードバックをお待ちしております。
