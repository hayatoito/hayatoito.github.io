...
- (2026年1月) 第4部の冒頭「[投資が下手な人の特徴を教えてください(仮)](#d50a)」を期間限定で公開。
- (2025年12月) 第4部「[細かすぎて伝わらない編（仮）](#41c))」を試験的に公開。現在 GitHub スポンサーの仕組みを利用した限定公開です。
- (2025年12月) 書籍版の内容を基に全面的に更新。
...
> （図はWeb版では割愛、[書籍版] P52 に掲載）([元画像](./compare-4275.png))
...
> （図はWeb版では割愛、[書籍版] P62に掲載) ([元画像A](./return-5-risk-5-pdf.png), [html-A](./return-5-risk-5-pdf.html), [元画像B](./return-5-risk-20-pdf.png), [html-B](./return-5-risk-20-pdf.html))
...
> （図はWeb版では割愛、[書籍版] P65に掲載) ([元画像A](./return-5-risk-5-var.png), [html-A](./return-5-risk-5-var.html), [元画像B](./return-5-risk-20-var.png), [html-B](./return-5-risk-20-var.html))
...
> （図はWeb版では割愛、[書籍版] P106に掲載) ([元画像](lsi-dca.png))
...
> （図はWeb版では割愛、[書籍版] P107に掲載) ([元画像](half-dca.png))
...
第4部では、書籍には掲載しづらいためあえて割愛したトピックや、書籍を読んでも一部の人が誤解している点、さらに投資界隈でまことしやかに囁かれる「都市伝説」的な話題についてまとめています。

これらは文脈を誤ると誤解を招く恐れがあったり、議論の余地が大きかったりするため、現在はスポンサーの方々への限定公開（β版）としています。
...
もし記事の内容に価値を感じていただけましたら、「スポンサー」として応援していただけると嬉しいです。参加方法は [こちら](https://github.com/hayatoito/hayatoito.github.io/issues/87) からご確認ください（月額1ドル〜）。

あくまでおまけとしてですが、スポンサーの皆様には、「第4部」の内容を含む開発中の [プライベートリポジトリ](https://github.com/99-investing/99-investing)へのアクセス権限が自動的に付与されます。ぜひ皆様からのフィードバックをお待ちしております。

</div>

## 投資が下手な人の特徴を教えてください。忖度ない意見をお願いします。 {#d50a}

以下のような発言をする人・行動をする人は、投資が下手だと思います。

- 「株価が下がったときこそ、積立をやめるべきではない。むしろ仕込み時である」
  - 理由)
    「仕込み時」という言葉を使う時点で、ほぼ間違いなく投資が下手です。これはマーケットタイミングが読めると思い込んでいるか、「下がった分だけ上がりやすくなる」という「ギャンブラーの誤謬」に陥っているからです。「暴落が来るまで現金で待機する」という発想と、本質的には変わりません。

- 「円高になったときこそ、積立をやめるべきではない。むしろ仕込み時である」
  - 理由)
    同上です。投資が上手な人の辞書に「仕込み時」という言葉はありません。直前の動きが円高だろうと円安だろうと、あえて言うならどちらも平等に「買い時」だからです。「むしろ」と強調する必要はありません。

- 「"靴磨きの少年"が目立つようになってきたから、そろそろ高値警戒・暴落は近い」
  - 理由) 「靴磨きの少年」が目立つことと、今後の株価の推移には、因果関係はありません。

- 「インデックス投資でマーケットタイミングを読まず投資をしていると暴落が避けれません。暴落を避けるためには〇〇を勉強する必要がある」
  - 理由) 暴落が起きること・暴落でリスク資産が半分になることと、その投資手法が99点であることは、何の矛盾もなく両立します。暴落は避けるものではなく、すべての暴落はそのまま受け止めるべきものです。暴落を避けようとすればするほど、点数が下がります。

- 「たしかにこの方法は99点かもしれませんが、私は120点を目指しているんです！」
  - 理由) 本編で述べている通り、この99点は、理論上、もっとも最高のリターン・その上限を100点として、正規化した結果の点数です。それに対して、「120点！」というのは、「たしかに明日雨が降る確率は90%かもしれないが、私は明日雨が降る確率は120%だと思います！」と言うようなものです。確率は0%から100%の値しかとりません。

- 「効率的市場仮説は完全には成り立っていない。そこにチャンスがあるので、私は個別株でインデックス超えを目指す」
  - 理由)
    「効率的市場仮説は完全には成り立っていない」ことは、インデックス以外を買う（あるいはマーケットタイミングを図る）ための「必要条件」にはなり得ますが、「十分条件」ではありません。

- （同じ枠・例えばNISA等で）現在進行形で同時に2つ以上の投資商品を積立てしている。
  - 理由)
    商品を分けることが「リスク分散」になると思い込んでいます。投資信託やその他のリスク資産をパズルのように組み合わせて買う必要のある時代は、すでに終わっています。
- 「過去3年のリターンが高い商品を最近買って、その商品の（自分が保有していない期間を含んだ）過去3年のリターンを自慢する」
  - 理由)
    本編のサイコロの例を参照してください。サイコロの数が十分多ければ、過去3年の間「たまたま良い目が出続けたサイコロ」は簡単に見つかります。じゃんけん大会に必ず勝者がいるのと同じです。

- 「資産が少ない間はインデックスだと増えません。個別株でリスクをとって増やす必要があります。インデックスは資産が増えた後の守りのフェーズです」
  - 理由)
    トービンの分離定理を理解していません。この主張は、「給料30万円では資産が増えないので、給料20万円の職場に転職して増やす必要がある」と言っているのと同じで、目的と行動が矛盾しています。

- 「リスク許容度がわからないので、私は一括じゃなくて、少しずつ積立しているんです」
  - 理由)
    よく見かけますが、客観的には投資が下手な部類に入ります。「リスク許容度」をメンタルや感情の問題だと捉えているからです。本来、リスク許容度は企業の資金繰りと同じく、純粋に物理的（財務的）な問題です。「リスク許容度がわからない」と言うなら、それは資金繰りに困っていない、物理的な制限のない「幸せ」で「自由」な状態です。ならば、投資期間を最大化するためにフルインベストメントするのが数学的な正解となります。

- 「損切りルールをつくって、適切なタイミングで損切することが重要である。負けなければおのずと勝ちになる」
  - 理由)
    「損切り」という発想自体が、投資が下手な人の思考です。現代において「99点を取れる投資法」は簡単に実践することができ、損切りの場面は訪れません。「損切り」は短期売買を繰り返す人の古い発想です。売却するのは基本的に現金が必要になった時のみであり、その場合も全てではなく、必要な分だけの部分売却が通常です。なお「暴落したから全部売却した」というのは、本編で述べているように、とるべき行動が基本的には真逆です。

- 「インデックスで放置していても、投資は上手くならない。個別株のほうが成長できる」
  - 理由)
    「数学で99点を取っても数学ができるとは言えない。20点を取ったほうが成長できる」という言い訳と同じです。そもそもインデックスと個別株の間に明確な線引きはありません。インデックスは「個別株の集合」であり、「もっとも上手な個別株投資」を追求した結果が「（時価総額加重平均に対する）インデックス投資」です。
    現代では、「もっとも上手い個別株投資」は時間を掛けずに誰でも最初から簡単に実践できます。これに気づかず、インデックスではなく個別株で修練をするというのは、せっかく「もっとも上手い個別株投資」にゴールしたにもかかわらず、最初のふりだしに戻っているだけです。普通の人がふりだしに戻った場合は、人生は短すぎるため、一生かけても正解にたどり着けず、どんなに成長したところで30点くらいで終わるでしょう。
...
[書籍版]: https://www.amazon.co.jp/dp/4296001825
[早期アクセス]: https://github.com/99-investing/99-investing
