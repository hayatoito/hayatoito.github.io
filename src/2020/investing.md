...
「市場平均」とは一般には「時価総額加重平均」のことを意味します。ですので、先程のように「市場平均」
のことを「投資家の間の平均点」と称するのは、やや誤解を招く表現です。
実際には、「市場平均」は単なる「平均点」ではなくて「投資家の間の「理想的」な平均点」です。
「市場平均」を取り続けることは長期になればなるほど優位に働きます。
